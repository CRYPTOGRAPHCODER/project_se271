...
struct data
{
    ...
    std::string co_intro05 = "게임을 클리어하기 위해서는 필수과목과 선택과목에 해당하는 학점을 모두 채우면서 학기를 체력이 1 이상 남긴 채 종료하면 됩니다.\n게임 중 언제라도 체력이 0 이하로 내려간다면 게임 오버가 됩니다. 마지막 학기에 마지막 과목을 들은 뒤에도 체력이 0이 된다면, 게임 오버입니다.\n필수 과목의 목록은 따로 존재하지 않지만, 다른 과목보다 수강할 때 필요한 에너지가 더 많이 들어갑니다.";
    std::string co_intro06 = "돌아다니면서 얻을 수 있는 과목의 부담은, 해당 과목을 수강할 때 잃는 체력량에 비례합니다. 계산은 [과목의 해당 스탯 부담]/[플레이어의 스탯]의 합으로 구성됩니다.\n만약 특정한 과목의 이학 부담이 2000이고 플레이어의 이학 스탯이 10이라면, 총 200의 데미지를 입게 됩니다.\n친구들이나 교수님이 알려주는 과목의 정보는 실제 값과 조금 차이가 있을 수 있습니다.n\n그렇다면, 게임을 시작하겠습니다. 4년 (이상)의 기간동안 무사히 살아남아 졸업까지 해 보세요!";
    ...
    std::string msg_workload[2] = {" 과목의 수업 부담이 전부 ",
                                   " 과목의 수업 부담이 일부 "};
    ...
    std::string items[36] = {"", "데자바", "블루블", "피자", "치맥", "라면","마사지 쿠폰","3색 펜",
                             ...
                             "바이트코인","공대생의 영혼","식권","플레잉 카드","보드카","네크로노미콘","딱총나무 지팡이"};
    // 00:Empty
    ...
    // 29:Bytecoin          = Value varies Every turn
