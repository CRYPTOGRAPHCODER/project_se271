...
struct data
{
    ...
    std::string bt_main[9] = {"밖으로 나가기","컴퓨터 키기","상점으로 가기","방에서 휴식","","","","",""};
    ...
    std::string bt_internet[9] = {"","","","","","","","",""};
    std::string co_store = "상점에 도착했습니다.";
    std::string bt_store[9] = {"","","","","","","","",""};
    std::string co_rest = "집에서 휴식합니다. 체력을 회복합니다.";
    std::string bt_rest[9] = {"다음","","","","","","","",""};

    std::string co_meet_friend[0] = "-";
    std::string co_meet_friend[1] = "친구를 만났더니, 갑자기 친구가 인생 고민을 털어놓기 시작합니다.\n수강신청도 중요하지만, 친구의 고민만큼 중요한 것은 또 없죠. 고민을 들어주고, 내친김에 술도 한 잔 사 줍니다.";
    std::string co_meet_friend[2] = "친구가 수강 신청 과목에 대해서 흥미로운 이야기를 해 줍니다.";
    std::string co_meet_friend[3] = "친구가 오늘은 노래방이 어떠냐고 물어봅니다. 당연히 가야겠죠?";
    std::string co_meet_friend[4] = "-";
...
public:
    ...
    void generate_subjects(double level);
